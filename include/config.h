...
#define BBSHOME			"/var/maple_move"	/* BBS 的家 */
#define BAKPATH			"/var/maple_move/bak"	/* 備份檔的路徑 */


//#define BBSUID		10000
//#define BBSGID		100			/* Linux 請設為 999 */
#define BBSUID          	1005
#define BBSGID          	1005			/* Linux 請設為 999 */
...
#define MEICHU_WIN              /* smiler.090308: 梅竹賽更動站簽及 Class */
#undef  MEICHU_WIN
...
#define	HAVE_SYSOP_SUDOER	/* smiler.081215: 具ATOM權限者才可以 SYSOP 登入*/
...
#  define MAX_GAME_BETS		"10"	/* 賭金每次最多 10 元 */
#endif
...
#define MAXBOARD	8192		/* 最大開板個數 */

#define MAXACTIVE	5120		/* 最多同時上站人數 */
...
#define LINE_HEADER	5		/* more.c bhttpd.c 檔頭有三列 */
