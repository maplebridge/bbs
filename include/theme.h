...
#define COLOR8      "\033[1;34;47m"	/* feeter 加強標註 */
...
#define NECKER_POST_FILE	"[←]離開 [→]閱\讀 [^P]發表 [b]進板畫面 [d]刪除 [V]投票 [TAB]精華區 [h]說明\n" \
			COLOR3 "  檔名(f)  日 期 作  者       文  章  標  題%*s                 評:%s  人氣:%-4d \033[m"
...
#define FOOTER_MORE	\
COLOR1 " 瀏覽 P.%d (%d%%) " COLOR2 " (h)說明 \033[m" COLOR8 "(@)動畫播放\033[m" COLOR2 " (↑↓0$)移動 (/n)搜尋 (C)暫存 (←q)結束  \033[m"
...
#define FEETER_POST	\
COLOR1 " 文章列表 \033[m" COLOR8 " (f)編號/檔名切換\033[m" COLOR2 " (ry)回信 " COLOR8 "(/)搜尋\功\能整合鍵\033[m" COLOR2 " (x)轉錄 (V)投票 (u)新聞"
...
COLOR1 " 即時通   " COLOR2 " (^P/a/f)新增/文章/目錄 (E)編輯 (T)標題 (m)移動 (c)複製 (p^V)貼上   "
