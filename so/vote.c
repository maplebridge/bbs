...
{
#ifdef HAVE_LIGHTBAR
  XO_ITEM, vote_item_bar,       XO_ITEM,        'n',    "XO_ITEM",      "",
#endif
  XO_INIT, vote_init,           XO_INIT,        'n',    "XO_INIT",      "",
  XO_LOAD, vote_load,           XO_LOAD,        'n',    "XO_LOAD",      "",
  XO_HEAD, vote_head,           XO_HEAD,        'n',    "XO_HEAD",      "",
  XO_BODY, vote_body,           XO_BODY,        'n',    "XO_BODY",      "",

  /* itoc.010901: 按右鍵比較方便 */
  'r', vote_join,       'r',    'z',    "參加投票",     	"",
  'v', vote_join,       'v',    'p',    "參加投票",     	"",
  'R', vote_result,     'R',    'p',    "觀看投票結果", 	"",

  'V', vote_view,       'V',    'p',    "預覽投票/賭盤結果",    "",
  'E', vote_edit,       'E',    'p',    "編輯投票設定",         "",
  'o', vote_pal,        'o',    'p',    "編輯限制投票名單",     "",
  'd', vote_delete,     'd',    'p',    "刪除",         	"",
  'D', vote_rangedel,   'D',    'p',    "區段刪除",     	"",
  't', vote_tag,        't',    'p',    "切換標籤",     	"",
  'b', vote_open,       'b',    'p',    "立即投票",     	"",

  Ctrl('D'), vote_prune,        Ctrl('D'),      'p',    "刪除標籤所選", 	"",
  Ctrl('G'), vote_pal,          Ctrl('G'),      'p',    "編輯限制投票名單",	"",
