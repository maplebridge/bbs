...
{
#ifdef HAVE_LIGHTBAR
  XO_ITEM, aloha_item_bar,      XO_ITEM,        'n',    "XO_ITEM",      "",
#endif
  XO_INIT, aloha_init,          XO_INIT,        'n',    "XO_INIT",      "",
  XO_LOAD, aloha_load,          XO_LOAD,        'n',    "XO_LOAD",      "",
  XO_HEAD, aloha_head,          XO_HEAD,        'n',    "XO_HEAD",      "",
  XO_BODY, aloha_body,          XO_BODY,        'n',    "XO_BODY",      "",

  'a', aloha_add,       'a',    'p',    "新增",         		"",
  'd', aloha_delete,    'd',    'p',    "刪除",         		"",
  'm', aloha_mail,      'm',    'p',    "寄信給對方",   		"",
  'w', aloha_write,     'w',    'p',    "傳送水球給對方",       	"",
  'D', aloha_rangedel,  'D',    'p',    "區段刪除",     		"",
  'f', aloha_loadpal,   'f',    'p',    "引入朋友名單", 		"",

  'r', aloha_query,     'r',    'z',    "查詢對方",     		"",
  Ctrl('Q'), aloha_query,       Ctrl('Q'),      'p',    "查詢對方",     "",

  's', aloha_sort,      's',    'p',    "整理名單",     		"",
