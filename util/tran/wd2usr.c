...
#define OLDUFO_MOVIE		000000000001	/* 開/關動態看板 */
#define OLDUFO_COLOR		000000000002	/* 彩色/黑白切換 */
#define OLDUFO_NOTE		000000000004	/* 顯示留言板 */
#define OLDUFO_ALARM		000000000010	/* 半點報時 */
#define OLDUFO_BELL		000000000020	/* 聲音 */
#define OLDUFO_BOARDLIST	000000000040	/* 看板列表顯示文章數或是編號 */
#define OLDUFO_SEELOG		000000000100	/* 上站都去看紀錄排名? */
#define OLDUFO_CYCLE		000000000200	/* 循環式閱讀 */
...
#define OLDUFO_ALREADYSET 	000000010000	/* 每次上站都設定? */
  ...
  userec *old;
{
  ...
  new.signature = 0;
  new.year = old->year - 11;	/* 西元換成民國 */
  new.month = old->month;
  new.day = old->day;
  new.sex = 1 - (old->sex % 2);	/* (0)葛格 (1)姐接 (2)底迪 (3)美眉 (4)薯叔 (5)阿姨 (6)植物 (7)礦物 */
